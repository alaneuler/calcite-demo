...
public class OptimizationRelatedRules {
  ...
  public static final MaterializedViewOnlyFilterRule INSTANCE_FILTER =
      (MaterializedViewOnlyFilterRule)
          MaterializedViewOnlyFilterRule.Config.DEFAULT
              .withGenerateUnionRewriting(true)
              .withFastBailOut(false)
              .withUnionRewritingPullProgram(PROGRAM)
              .withRelBuilderFactory(RelFactories.LOGICAL_BUILDER)
  ...
  public static final MaterializedViewProjectJoinRule INSTANCE_PROJECT_JOIN =
      (MaterializedViewProjectJoinRule)
          MaterializedViewProjectJoinRule.Config.DEFAULT
              .withGenerateUnionRewriting(true)
              .withFastBailOut(false)
              .withUnionRewritingPullProgram(PROGRAM)
              .withRelBuilderFactory(RelFactories.LOGICAL_BUILDER)
  ...
  public static final MaterializedViewOnlyJoinRule INSTANCE_JOIN =
      (MaterializedViewOnlyJoinRule)
          MaterializedViewOnlyJoinRule.Config.DEFAULT
              .withGenerateUnionRewriting(true)
              .withFastBailOut(false)
              .withUnionRewritingPullProgram(PROGRAM)
              .withRelBuilderFactory(RelFactories.LOGICAL_BUILDER)
  ...
  public static final MaterializedViewOnlyAggregateRule INSTANCE_AGGREGATE =
      (MaterializedViewOnlyAggregateRule)
          MaterializedViewOnlyAggregateRule.Config.DEFAULT.withFastBailOut(false).toRule();

  public static final MaterializedViewProjectAggregateRule INSTANCE_PROJECT_AGGREGATE =
      (MaterializedViewProjectAggregateRule)
          MaterializedViewProjectAggregateRule.Config.DEFAULT.withFastBailOut(false).toRule();

  public static final MaterializedViewFilterScanRule INSTANCE_FILTER_SCAN =
